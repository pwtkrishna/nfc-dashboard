...
const ProfileListCard = ({ profile, mutate }: Props) => {
  ...
  return (
    <div className="pl-6 pt-6 basis-[25%] grow-0 max-w-1/4 max-lg:basis-[33.3333%] max-lg:max-w-1/3 max-sm:basis-[50%] max-sm:max-w-1/2">
      <div className="flex flex-col gap-4 pt-4 px-4 pb-3 bg-white rounded-[0.5rem] overflow-hidden cursor-pointer [box-shadow:0_0_5px_rgb(196,196,196)] hover:[box-shadow:0_0_5px_rgb(0,168,204)]">
        <div>
          <Image
        ...
        <div className="flex items-center gap-4 w-full h-[70px] ">
          ...
          <div>
            <h6 className="user-profile-name text-base leading-[1.6] text-[#191724] font-semibold">
              {name}
            </h6>
            <p className="profile-card__job-title font-normal text-[0.875rem] leading-[1.43] text-[rgb(107,114,128)]">
 ...
 cursor-pointer hover:text-black hover:bg-[rgba(0,168,204,0.04)]"
                focusable="false"
                aria-hidden="true"
                viewBox="0 0 24 24"
